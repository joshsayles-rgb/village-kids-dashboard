  ...
  _schedRows(rows) {
    ...
    return rows.map((r, i) => {
      ...
      return '<div class="sched-row' + (isNow ? ' now' : '') + '">'
        ...
        + '<span class="sched-event">' + esc(r.event) + (isNow ? '<span class="now-pill" style="background:' + (State.roomMode ? getRoomColor(State.roomMode).primary : 'var(--red)') + '">Now</span>' : '') + '</span>'
