...
const CD = {
  ...
  tick() {
    ...
    // Pickup detection
    // Pickup banner removed - countdown bar already shows pickup info
...
const GREETINGS = [
  ...
  { time: 'late',    text: "There is no such thing as a perfect Sunday morning. There is only this one. Make it count." },
];
...
const Greeting = {
  init() {
    ...
    el('greetingText').textContent = getGreeting();
  }
};
